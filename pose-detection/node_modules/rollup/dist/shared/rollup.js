...
function loadFsEvents() {
    return new Promise(function (resolve) { resolve(_interopNamespace(require('fsevents'))); })
        .then(namespace => {
...
function watch(configs) {
    ...
    loadFsEvents()
        .then(() => new Promise(function (resolve) { resolve(require('./watch.js')); }))
...
exports.parseInputOptions = parseInputOptions;
exports.parseOutputOptions = parseOutputOptions;

...
(0, jasmine_util_1.describeWithFlags)('MoveNet', jasmine_util_1.ALL_ENVS, function () {
    var detector;
    var timeout;
    beforeAll(function () {
...
(0, jasmine_util_1.describeWithFlags)('MoveNet video ', jasmine_util_1.BROWSER_ENVS, function () {
    var detector;
    var timeout;
    var expected;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("".concat(test_util_2.KARMA_SERVER, "/pose_1.json"))
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, test_util_2.loadVideo)('pose_1.mp4', 30 /* fps */, callback, expected, poseDetection.util.getAdjacentPairs(model), simulatedInterval)];
                case 2:
                    // Synthetic video at 30FPS.
                    _a.sent();

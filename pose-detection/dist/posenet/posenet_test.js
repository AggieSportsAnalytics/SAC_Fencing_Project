...
(0, jasmine_util_1.describeWithFlags)('PoseNet', jasmine_util_1.ALL_ENVS, function () {
    var detector;
    var timeout;
    beforeAll(function () {
    ...
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, poseDetection.createDetector(poseDetection.SupportedModels.PoseNet, {
                        quantBytes: 4,
    ...
    it('estimatePoses with multiple poses does not leak memory', function () { return __awaiter(void 0, void 0, void 0, function () {
        var input, beforeTensors;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    input = tf.zeros([128, 128, 3]);
                    beforeTensors = tf.memory().numTensors;
                    return [4 /*yield*/, detector.estimatePoses(input, { maxPoses: 2 })];
                case 1:
                    _a.sent();
                    expect(tf.memory().numTensors).toEqual(beforeTensors);
                    return [2 /*return*/];
